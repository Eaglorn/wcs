...
do
    ...
    function CAT_TerrainBounce(gizmo, x, y, z)
        ...
        gizmo.x, gizmo.y, gizmo.z = x + gizmo.vx / vTotal * overShoot, y + gizmo.vy / vTotal * overShoot,
            gizmo.z + gizmo.vz / vTotal * overShoot
    ...
    local function InitGizmosCAT()
        ...
        CAT_SetGizmoBounds(GetRectMinX(worldBounds), GetRectMinY(worldBounds), GetRectMaxX(worldBounds),
            GetRectMaxY(worldBounds))
