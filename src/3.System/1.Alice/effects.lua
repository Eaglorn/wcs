...
do
    ...
    local function InitAnimateShadow(gizmo)
        ...
        gizmo.shadow = CreateImage(gizmo.shadowPath, gizmo.shadowWidth, gizmo.shadowHeight, 0,
            gizmo.x + (gizmo.shadowX) - 0.5 * gizmo.shadowWidth, gizmo.y + (gizmo.shadowY) - 0.5 * gizmo.shadowHeight, 0,
            0, 0, 0, 1)
    ...
    function CAT_AnimateShadow(gizmo)
        ...
        SetImagePosition(gizmo.shadow, gizmo.x + gizmo.shadowX - 0.5 * gizmo.shadowWidth,
            gizmo.y + gizmo.shadowY - 0.5 * gizmo.shadowHeight, 0)
    ...
    function CAT_MoveAttachedEffect(gizmo)
        if IsHandle[gizmo.attachedEffect] then
            BlzSetSpecialEffectPosition(gizmo.attachedEffect, gizmo.x, gizmo.y,
                (gizmo.z or GetTerrainZ(gizmo.x, gizmo.y)) + gizmo.attachedEffectZ)
        else
            for index, effect in ipairs(gizmo.attachedEffect) do
                BlzSetSpecialEffectPosition(effect, gizmo.x, gizmo.y,
                    (gizmo.z or GetTerrainZ(gizmo.x, gizmo.y)) + gizmo.attachedEffectZ[index])
            end
        end
        if gizmo.isResting then
            ALICE_PairPause()
    ...
    function CAT_Orient3D(gizmo)
        if gizmo.vx ~= 0 or gizmo.vy ~= 0 or gizmo.vz ~= 0 then
            BlzSetSpecialEffectOrientation(gizmo.visual, atan2(gizmo.vy, gizmo.vx),
                atan2(-gizmo.vz, sqrt(gizmo.vx ^ 2 + gizmo.vy ^ 2)), 0)
        end
        if gizmo.isResting then
            ALICE_PairPause()
        end
    ...
    function CAT_OrientPropelled3D(gizmo)
        if gizmo.ax ~= 0 or gizmo.ay ~= 0 or gizmo.az ~= 0 then
            BlzSetSpecialEffectOrientation(gizmo.visual, atan2(gizmo.ay, gizmo.ax),
                atan2(-gizmo.az, sqrt(gizmo.ax ^ 2 + gizmo.ay ^ 2)), 0)
        end
        return 0.1
    end
    ...
    local function InitOrientation(gizmo)
        ...
        BlzSetSpecialEffectOrientation(gizmo.visual, atan2(-gizmo.O12, gizmo.O11),
            atan2(gizmo.O13, sqrt(gizmo.O12 ^ 2 + gizmo.O11 ^ 2)), atan2(gizmo.O23, gizmo.O33))
    end
    ...
    function CAT_OrientRoll(gizmo)
        ...
        gizmo.O11, gizmo.O12, gizmo.O13, gizmo.O21, gizmo.O22, gizmo.O23, gizmo.O31, gizmo.O32, gizmo.O33 = O11, O12, O13,
