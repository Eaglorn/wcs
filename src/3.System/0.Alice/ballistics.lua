...
do
        ...
        elseif gizmo.isAirborne then
            ...
            if vHorizontal > 0 then
                ...
                if freeFallCurvature > curvature then
                    ...
                    local frictionMultiplier = (freeFallCurvature - curvature) /
                    freeFallCurvature                                                            --If the object is pressed against the surface due to its curvature, the friction increases.
                    ...
                    if curvature > 0.0015 then                                 --Don't run this calculation unless curvature is high enough (dz > ~50)
                        curvatureAngle = atan2(z2 - z, 32) -
                        atan2(z - z1, 32)                                      --Gradient angle difference between two neighboring tiles.
    ...
    function CAT_GetBallisticLaunchSpeedFromVelocity(xLaunch, yLaunch, zLaunch, xTarget, yTarget, zTarget, velocity,
                                                     highArc)
