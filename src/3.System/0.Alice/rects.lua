...
do
    ...
    function CAT_DoRectsIntersect(rect1, rect2)
        return rect1.maxX > rect2.minX and rect1.minX < rect2.maxX and rect1.maxY > rect2.minY and
    ...
    function CAT_IsRectInRect(smallerRect, largerRect)
        return smallerRect.minX >= largerRect.minX and smallerRect.maxX <= largerRect.maxX and
        smallerRect.minY >= largerRect.minY and smallerRect.maxY <= largerRect.maxY
    end
