    ...
    Debug = {
        ...
        settings = {
            ...
            colors = {
                ...
                ,
                log =
                '888888' ---@type string Color to be applied to logged messages through Debug.log().
                ,
                    ...
                    if next(object) == nil then
                        ...
                        for k, v in pairs(object) do
                            table.insert(mappedKV,
                                ...
                                indent ..
                                '[' ..
                                prettyTostring(k, depth - 1, constTable, indent .. "  ") ..
                                '] = ' .. prettyTostring(v, depth - 1, constTable, indent .. "  "))
                        end
