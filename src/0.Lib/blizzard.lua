...
---20.00
---@type real
bj_TEXT_DELAY_QUEST = nil

---20.00
---@type real
bj_TEXT_DELAY_QUESTUPDATE = nil

---20.00
---@type real
bj_TEXT_DELAY_QUESTDONE = nil

---20.00
---@type real
bj_TEXT_DELAY_QUESTFAILED = nil

---20.00
---@type real
bj_TEXT_DELAY_QUESTREQUIREMENT = nil

---20.00
---@type real
bj_TEXT_DELAY_MISSIONFAILED = nil

---12.00
---@type real
bj_TEXT_DELAY_ALWAYSHINT = nil

---12.00
---@type real
bj_TEXT_DELAY_HINT = nil

---10.00
---@type real
bj_TEXT_DELAY_SECRET = nil

---15.00
---@type real
bj_TEXT_DELAY_UNITACQUIRED = nil

---10.00
---@type real
bj_TEXT_DELAY_UNITAVAILABLE = nil

---10.00
---@type real
bj_TEXT_DELAY_ITEMACQUIRED = nil

---12.00
---@type real
bj_TEXT_DELAY_WARNING = nil

---5.00
---@type real
bj_QUEUE_DELAY_QUEST = nil

---5.00
---@type real
bj_QUEUE_DELAY_HINT = nil

---3.00
---@type real
bj_QUEUE_DELAY_SECRET = nil

---60.00
---@type real
bj_HANDICAP_EASY = nil

---90.00
---@type real
bj_HANDICAP_NORMAL = nil

---50.00
---@type real
bj_HANDICAPDAMAGE_EASY = nil

---90.00
---@type real
bj_HANDICAPDAMAGE_NORMAL = nil

---50.00
---@type real
bj_HANDICAPREVIVE_NOTHARD = nil

---0.01
---@type real
bj_GAME_STARTED_THRESHOLD = nil

---0.10
---@type real
bj_WAIT_FOR_COND_MIN_INTERVAL = nil

---0.10
---@type real
bj_POLLED_WAIT_INTERVAL = nil

---2.00
---@type real
bj_POLLED_WAIT_SKIP_THRESHOLD = nil

---6
---@type integer
bj_MAX_INVENTORY = nil
...
---@type integer
bj_PLAYER_NEUTRAL_VICTIM = nil

---GetBJPlayerNeutralExtra()
---@type integer
bj_PLAYER_NEUTRAL_EXTRA = nil

---GetBJMaxPlayerSlots()
---@type integer
bj_MAX_PLAYER_SLOTS = nil

---25
---@type integer
bj_MAX_SKELETONS = nil

---11
---@type integer
bj_MAX_STOCK_ITEM_SLOTS = nil

---11
---@type integer
bj_MAX_STOCK_UNIT_SLOTS = nil

---10
---@type integer
bj_MAX_ITEM_LEVEL = nil

---5
---@type integer
bj_MAX_CHECKPOINTS = nil
...
---8.00
---@type real
bj_MELEE_STARTING_TOD = nil

---750
---@type integer
bj_MELEE_STARTING_GOLD_V0 = nil

---500
---@type integer
bj_MELEE_STARTING_GOLD_V1 = nil

---200
---@type integer
bj_MELEE_STARTING_LUMBER_V0 = nil

---150
---@type integer
bj_MELEE_STARTING_LUMBER_V1 = nil

---1
---@type integer
bj_MELEE_STARTING_HERO_TOKENS = nil

---3
---@type integer
bj_MELEE_HERO_LIMIT = nil

---1
---@type integer
bj_MELEE_HERO_TYPE_LIMIT = nil

---2000
---@type real
bj_MELEE_MINE_SEARCH_RADIUS = nil

---1500
---@type real
bj_MELEE_CLEAR_UNITS_RADIUS = nil

---120.00
---@type real
bj_MELEE_CRIPPLE_TIMEOUT = nil

---20.00
---@type real
bj_MELEE_CRIPPLE_MSG_DURATION = nil

---3
---@type integer
bj_MELEE_MAX_TWINKED_HEROES_V0 = nil

---1
---@type integer
bj_MELEE_MAX_TWINKED_HEROES_V1 = nil

---0.50
---@type real
bj_CREEP_ITEM_DELAY = nil

---120
---@type real
bj_STOCK_RESTOCK_INITIAL_DELAY = nil

---30
---@type real
bj_STOCK_RESTOCK_INTERVAL = nil

---20
---@type integer
bj_STOCK_MAX_ITERATIONS = nil

---64
---@type integer
bj_MAX_DEST_IN_REGION_EVENTS = nil

---100
---@type integer
bj_CAMERA_MIN_FARZ = nil

---1650
---@type integer
bj_CAMERA_DEFAULT_DISTANCE = nil

---5000
---@type integer
bj_CAMERA_DEFAULT_FARZ = nil

---304
---@type integer
bj_CAMERA_DEFAULT_AOA = nil

---70
---@type integer
bj_CAMERA_DEFAULT_FOV = nil

---0
---@type integer
bj_CAMERA_DEFAULT_ROLL = nil

---90
---@type integer
bj_CAMERA_DEFAULT_ROTATION = nil

---2.00
---@type real
bj_RESCUE_PING_TIME = nil

---5.00
---@type real
bj_NOTHING_SOUND_DURATION = nil

---1.00
---@type real
bj_TRANSMISSION_PING_TIME = nil

---255
---@type integer
bj_TRANSMISSION_IND_RED = nil

---255
---@type integer
bj_TRANSMISSION_IND_BLUE = nil

---255
---@type integer
bj_TRANSMISSION_IND_GREEN = nil

---255
---@type integer
bj_TRANSMISSION_IND_ALPHA = nil

---1.50
---@type real
bj_TRANSMISSION_PORT_HANGTIME = nil

---0.50
---@type real
bj_CINEMODE_INTERFACEFADE = nil

---MAP_SPEED_NORMAL
---@type gamespeed
bj_CINEMODE_GAMESPEED = nil

---0.40
---@type real
bj_CINEMODE_VOLUME_UNITMOVEMENT = nil

---0.00
---@type real
bj_CINEMODE_VOLUME_UNITSOUNDS = nil

---0.40
---@type real
bj_CINEMODE_VOLUME_COMBAT = nil

---0.40
---@type real
bj_CINEMODE_VOLUME_SPELLS = nil

---0.00
---@type real
bj_CINEMODE_VOLUME_UI = nil

---0.55
---@type real
bj_CINEMODE_VOLUME_MUSIC = nil

---1.00
---@type real
bj_CINEMODE_VOLUME_AMBIENTSOUNDS = nil

---0.60
---@type real
bj_CINEMODE_VOLUME_FIRE = nil

---0.25
---@type real
bj_SPEECH_VOLUME_UNITMOVEMENT = nil

---0.00
---@type real
bj_SPEECH_VOLUME_UNITSOUNDS = nil

---0.25
---@type real
bj_SPEECH_VOLUME_COMBAT = nil

---0.25
---@type real
bj_SPEECH_VOLUME_SPELLS = nil

---0.00
---@type real
bj_SPEECH_VOLUME_UI = nil

---0.55
---@type real
bj_SPEECH_VOLUME_MUSIC = nil

---1.00
---@type real
bj_SPEECH_VOLUME_AMBIENTSOUNDS = nil

---0.60
---@type real
bj_SPEECH_VOLUME_FIRE = nil

---500
---@type real
bj_SMARTPAN_TRESHOLD_PAN = nil

---3500
---@type real
bj_SMARTPAN_TRESHOLD_SNAP = nil

---100
---@type integer
bj_MAX_QUEUED_TRIGGERS = nil

---180.00
---@type real
bj_QUEUED_TRIGGER_TIMEOUT = nil

---0
---@type integer
bj_CAMPAIGN_INDEX_T = nil

---1
---@type integer
bj_CAMPAIGN_INDEX_H = nil

---2
---@type integer
bj_CAMPAIGN_INDEX_U = nil

---3
---@type integer
bj_CAMPAIGN_INDEX_O = nil

---4
---@type integer
bj_CAMPAIGN_INDEX_N = nil

---5
---@type integer
bj_CAMPAIGN_INDEX_XN = nil

---6
---@type integer
bj_CAMPAIGN_INDEX_XH = nil

---7
---@type integer
bj_CAMPAIGN_INDEX_XU = nil

---8
---@type integer
bj_CAMPAIGN_INDEX_XO = nil

---0
---@type integer
bj_CAMPAIGN_OFFSET_T = nil

---1
---@type integer
bj_CAMPAIGN_OFFSET_H = nil

---2
---@type integer
bj_CAMPAIGN_OFFSET_U = nil

---3
---@type integer
bj_CAMPAIGN_OFFSET_O = nil

---4
---@type integer
bj_CAMPAIGN_OFFSET_N = nil

---5
---@type integer
bj_CAMPAIGN_OFFSET_XN = nil

---6
---@type integer
bj_CAMPAIGN_OFFSET_XH = nil

---7
---@type integer
bj_CAMPAIGN_OFFSET_XU = nil

---8
---@type integer
bj_CAMPAIGN_OFFSET_XO = nil

---bj_CAMPAIGN_OFFSET_T * 1000 + 0
---@type integer
bj_MISSION_INDEX_T00 = nil

---bj_CAMPAIGN_OFFSET_T * 1000 + 1
---@type integer
bj_MISSION_INDEX_T01 = nil

---bj_CAMPAIGN_OFFSET_T * 1000 + 2
---@type integer
bj_MISSION_INDEX_T02 = nil

---bj_CAMPAIGN_OFFSET_T * 1000 + 3
---@type integer
bj_MISSION_INDEX_T03 = nil

---bj_CAMPAIGN_OFFSET_T * 1000 + 4
---@type integer
bj_MISSION_INDEX_T04 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 0
---@type integer
bj_MISSION_INDEX_H00 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 1
---@type integer
bj_MISSION_INDEX_H01 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 2
---@type integer
bj_MISSION_INDEX_H02 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 3
---@type integer
bj_MISSION_INDEX_H03 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 4
---@type integer
bj_MISSION_INDEX_H04 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 5
---@type integer
bj_MISSION_INDEX_H05 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 6
---@type integer
bj_MISSION_INDEX_H06 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 7
---@type integer
bj_MISSION_INDEX_H07 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 8
---@type integer
bj_MISSION_INDEX_H08 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 9
---@type integer
bj_MISSION_INDEX_H09 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 10
---@type integer
bj_MISSION_INDEX_H10 = nil

---bj_CAMPAIGN_OFFSET_H * 1000 + 11
---@type integer
bj_MISSION_INDEX_H11 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 0
---@type integer
bj_MISSION_INDEX_U00 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 1
---@type integer
bj_MISSION_INDEX_U01 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 2
---@type integer
bj_MISSION_INDEX_U02 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 3
---@type integer
bj_MISSION_INDEX_U03 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 4
---@type integer
bj_MISSION_INDEX_U05 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 5
---@type integer
bj_MISSION_INDEX_U07 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 6
---@type integer
bj_MISSION_INDEX_U08 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 7
---@type integer
bj_MISSION_INDEX_U09 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 8
---@type integer
bj_MISSION_INDEX_U10 = nil

---bj_CAMPAIGN_OFFSET_U * 1000 + 9
---@type integer
bj_MISSION_INDEX_U11 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 0
---@type integer
bj_MISSION_INDEX_O00 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 1
---@type integer
bj_MISSION_INDEX_O01 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 2
---@type integer
bj_MISSION_INDEX_O02 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 3
---@type integer
bj_MISSION_INDEX_O03 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 4
---@type integer
bj_MISSION_INDEX_O04 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 5
---@type integer
bj_MISSION_INDEX_O05 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 6
---@type integer
bj_MISSION_INDEX_O06 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 7
---@type integer
bj_MISSION_INDEX_O07 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 8
---@type integer
bj_MISSION_INDEX_O08 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 9
---@type integer
bj_MISSION_INDEX_O09 = nil

---bj_CAMPAIGN_OFFSET_O * 1000 + 10
---@type integer
bj_MISSION_INDEX_O10 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 0
---@type integer
bj_MISSION_INDEX_N00 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 1
---@type integer
bj_MISSION_INDEX_N01 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 2
---@type integer
bj_MISSION_INDEX_N02 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 3
---@type integer
bj_MISSION_INDEX_N03 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 4
---@type integer
bj_MISSION_INDEX_N04 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 5
---@type integer
bj_MISSION_INDEX_N05 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 6
---@type integer
bj_MISSION_INDEX_N06 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 7
---@type integer
bj_MISSION_INDEX_N07 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 8
---@type integer
bj_MISSION_INDEX_N08 = nil

---bj_CAMPAIGN_OFFSET_N * 1000 + 9
---@type integer
bj_MISSION_INDEX_N09 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 0
---@type integer
bj_MISSION_INDEX_XN00 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 1
---@type integer
bj_MISSION_INDEX_XN01 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 2
---@type integer
bj_MISSION_INDEX_XN02 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 3
---@type integer
bj_MISSION_INDEX_XN03 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 4
---@type integer
bj_MISSION_INDEX_XN04 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 5
---@type integer
bj_MISSION_INDEX_XN05 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 6
---@type integer
bj_MISSION_INDEX_XN06 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 7
---@type integer
bj_MISSION_INDEX_XN07 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 8
---@type integer
bj_MISSION_INDEX_XN08 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 9
---@type integer
bj_MISSION_INDEX_XN09 = nil

---bj_CAMPAIGN_OFFSET_XN * 1000 + 10
---@type integer
bj_MISSION_INDEX_XN10 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 0
---@type integer
bj_MISSION_INDEX_XH00 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 1
---@type integer
bj_MISSION_INDEX_XH01 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 2
---@type integer
bj_MISSION_INDEX_XH02 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 3
---@type integer
bj_MISSION_INDEX_XH03 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 4
---@type integer
bj_MISSION_INDEX_XH04 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 5
---@type integer
bj_MISSION_INDEX_XH05 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 6
---@type integer
bj_MISSION_INDEX_XH06 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 7
---@type integer
bj_MISSION_INDEX_XH07 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 8
---@type integer
bj_MISSION_INDEX_XH08 = nil

---bj_CAMPAIGN_OFFSET_XH * 1000 + 9
---@type integer
bj_MISSION_INDEX_XH09 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 0
---@type integer
bj_MISSION_INDEX_XU00 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 1
---@type integer
bj_MISSION_INDEX_XU01 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 2
---@type integer
bj_MISSION_INDEX_XU02 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 3
---@type integer
bj_MISSION_INDEX_XU03 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 4
---@type integer
bj_MISSION_INDEX_XU04 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 5
---@type integer
bj_MISSION_INDEX_XU05 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 6
---@type integer
bj_MISSION_INDEX_XU06 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 7
---@type integer
bj_MISSION_INDEX_XU07 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 8
---@type integer
bj_MISSION_INDEX_XU08 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 9
---@type integer
bj_MISSION_INDEX_XU09 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 10
---@type integer
bj_MISSION_INDEX_XU10 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 11
---@type integer
bj_MISSION_INDEX_XU11 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 12
---@type integer
bj_MISSION_INDEX_XU12 = nil

---bj_CAMPAIGN_OFFSET_XU * 1000 + 13
---@type integer
bj_MISSION_INDEX_XU13 = nil

---bj_CAMPAIGN_OFFSET_XO * 1000 + 0
---@type integer
bj_MISSION_INDEX_XO00 = nil

---bj_CAMPAIGN_OFFSET_XO * 1000 + 1
---@type integer
bj_MISSION_INDEX_XO01 = nil

---bj_CAMPAIGN_OFFSET_XO * 1000 + 2
---@type integer
bj_MISSION_INDEX_XO02 = nil

---bj_CAMPAIGN_OFFSET_XO * 1000 + 3
---@type integer
bj_MISSION_INDEX_XO03 = nil

---0
---@type integer
bj_CINEMATICINDEX_TOP = nil

---1
---@type integer
bj_CINEMATICINDEX_HOP = nil

---2
---@type integer
bj_CINEMATICINDEX_HED = nil

---3
---@type integer
bj_CINEMATICINDEX_OOP = nil

---4
---@type integer
bj_CINEMATICINDEX_OED = nil

---5
---@type integer
bj_CINEMATICINDEX_UOP = nil

---6
---@type integer
bj_CINEMATICINDEX_UED = nil

---7
---@type integer
bj_CINEMATICINDEX_NOP = nil

---8
---@type integer
bj_CINEMATICINDEX_NED = nil

---9
---@type integer
bj_CINEMATICINDEX_XOP = nil

---10
---@type integer
bj_CINEMATICINDEX_XED = nil

---0
---@type integer
bj_ALLIANCE_UNALLIED = nil

---1
---@type integer
bj_ALLIANCE_UNALLIED_VISION = nil

---2
---@type integer
bj_ALLIANCE_ALLIED = nil

---3
---@type integer
bj_ALLIANCE_ALLIED_VISION = nil

---4
---@type integer
bj_ALLIANCE_ALLIED_UNITS = nil

---5
---@type integer
bj_ALLIANCE_ALLIED_ADVUNITS = nil

---6
---@type integer
bj_ALLIANCE_NEUTRAL = nil

---7
---@type integer
bj_ALLIANCE_NEUTRAL_VISION = nil

---0
---@type integer
bj_KEYEVENTTYPE_DEPRESS = nil

---1
---@type integer
bj_KEYEVENTTYPE_RELEASE = nil

---0
---@type integer
bj_KEYEVENTKEY_LEFT = nil

---1
---@type integer
bj_KEYEVENTKEY_RIGHT = nil

---2
---@type integer
bj_KEYEVENTKEY_DOWN = nil

---3
---@type integer
bj_KEYEVENTKEY_UP = nil

---0
---@type integer
bj_MOUSEEVENTTYPE_DOWN = nil

---1
---@type integer
bj_MOUSEEVENTTYPE_UP = nil

---2
---@type integer
bj_MOUSEEVENTTYPE_MOVE = nil
...
---0
---@type integer
bj_CAMERABOUNDS_ADJUST_ADD = nil

---1
---@type integer
bj_CAMERABOUNDS_ADJUST_SUB = nil

---0
---@type integer
bj_QUESTTYPE_REQ_DISCOVERED = nil

---1
---@type integer
bj_QUESTTYPE_REQ_UNDISCOVERED = nil

---2
---@type integer
bj_QUESTTYPE_OPT_DISCOVERED = nil

---3
---@type integer
bj_QUESTTYPE_OPT_UNDISCOVERED = nil

---0
---@type integer
bj_QUESTMESSAGE_DISCOVERED = nil

---1
---@type integer
bj_QUESTMESSAGE_UPDATED = nil

---2
---@type integer
bj_QUESTMESSAGE_COMPLETED = nil

---3
---@type integer
bj_QUESTMESSAGE_FAILED = nil

---4
---@type integer
bj_QUESTMESSAGE_REQUIREMENT = nil

---5
---@type integer
bj_QUESTMESSAGE_MISSIONFAILED = nil

---6
---@type integer
bj_QUESTMESSAGE_ALWAYSHINT = nil

---7
---@type integer
bj_QUESTMESSAGE_HINT = nil

---8
---@type integer
bj_QUESTMESSAGE_SECRET = nil

---9
---@type integer
bj_QUESTMESSAGE_UNITACQUIRED = nil

---10
---@type integer
bj_QUESTMESSAGE_UNITAVAILABLE = nil

---11
---@type integer
bj_QUESTMESSAGE_ITEMACQUIRED = nil

---12
---@type integer
bj_QUESTMESSAGE_WARNING = nil

---0
---@type integer
bj_SORTTYPE_SORTBYVALUE = nil

---1
---@type integer
bj_SORTTYPE_SORTBYPLAYER = nil

---2
---@type integer
bj_SORTTYPE_SORTBYLABEL = nil

---0
---@type integer
bj_CINEFADETYPE_FADEIN = nil

---1
---@type integer
bj_CINEFADETYPE_FADEOUT = nil

---2
---@type integer
bj_CINEFADETYPE_FADEOUTIN = nil

---0
---@type integer
bj_REMOVEBUFFS_POSITIVE = nil

---1
---@type integer
bj_REMOVEBUFFS_NEGATIVE = nil

---2
---@type integer
bj_REMOVEBUFFS_ALL = nil

---3
---@type integer
bj_REMOVEBUFFS_NONTLIFE = nil

---0
---@type integer
bj_BUFF_POLARITY_POSITIVE = nil

---1
---@type integer
bj_BUFF_POLARITY_NEGATIVE = nil

---2
---@type integer
bj_BUFF_POLARITY_EITHER = nil

---0
---@type integer
bj_BUFF_RESIST_MAGIC = nil

---1
---@type integer
bj_BUFF_RESIST_PHYSICAL = nil

---2
---@type integer
bj_BUFF_RESIST_EITHER = nil

---3
---@type integer
bj_BUFF_RESIST_BOTH = nil
...
---0
---@type integer
bj_MODIFYMETHOD_ADD = nil

---1
---@type integer
bj_MODIFYMETHOD_SUB = nil

---2
---@type integer
bj_MODIFYMETHOD_SET = nil

---0
---@type integer
bj_UNIT_STATE_METHOD_ABSOLUTE = nil

---1
---@type integer
bj_UNIT_STATE_METHOD_RELATIVE = nil

---2
---@type integer
bj_UNIT_STATE_METHOD_DEFAULTS = nil

---3
---@type integer
bj_UNIT_STATE_METHOD_MAXIMUM = nil

---0
---@type integer
bj_GATEOPERATION_CLOSE = nil

---1
---@type integer
bj_GATEOPERATION_OPEN = nil

---2
---@type integer
bj_GATEOPERATION_DESTROY = nil

---0
---@type integer
bj_GAMECACHE_BOOLEAN = nil

---1
---@type integer
bj_GAMECACHE_INTEGER = nil

---2
---@type integer
bj_GAMECACHE_REAL = nil

---3
---@type integer
bj_GAMECACHE_UNIT = nil

---4
---@type integer
bj_GAMECACHE_STRING = nil

---0
---@type integer
bj_HASHTABLE_BOOLEAN = nil

---1
---@type integer
bj_HASHTABLE_INTEGER = nil

---2
---@type integer
bj_HASHTABLE_REAL = nil

---3
---@type integer
bj_HASHTABLE_STRING = nil

---4
---@type integer
bj_HASHTABLE_HANDLE = nil

---0
---@type integer
bj_ITEM_STATUS_HIDDEN = nil

---1
---@type integer
bj_ITEM_STATUS_OWNED = nil

---2
---@type integer
bj_ITEM_STATUS_INVULNERABLE = nil

---3
---@type integer
bj_ITEM_STATUS_POWERUP = nil

---4
---@type integer
bj_ITEM_STATUS_SELLABLE = nil

---5
---@type integer
bj_ITEM_STATUS_PAWNABLE = nil

---0
---@type integer
bj_ITEMCODE_STATUS_POWERUP = nil

---1
---@type integer
bj_ITEMCODE_STATUS_SELLABLE = nil

---2
---@type integer
bj_ITEMCODE_STATUS_PAWNABLE = nil

---0
---@type integer
bj_MINIMAPPINGSTYLE_SIMPLE = nil

---1
---@type integer
bj_MINIMAPPINGSTYLE_FLASHY = nil

---2
---@type integer
bj_MINIMAPPINGSTYLE_ATTACK = nil

---0
---@type integer
bj_CAMPPINGSTYLE_PRIMARY = nil

---1
---@type integer
bj_CAMPPINGSTYLE_PRIMARY_GREEN = nil

---2
---@type integer
bj_CAMPPINGSTYLE_PRIMARY_RED = nil

---3
---@type integer
bj_CAMPPINGSTYLE_BONUS = nil

---4
---@type integer
bj_CAMPPINGSTYLE_TURNIN = nil

---5
---@type integer
bj_CAMPPINGSTYLE_BOSS = nil

---6
---@type integer
bj_CAMPPINGSTYLE_CONTROL_ALLY = nil

---7
---@type integer
bj_CAMPPINGSTYLE_CONTROL_NEUTRAL = nil

---8
---@type integer
bj_CAMPPINGSTYLE_CONTROL_ENEMY = nil

---8.00
---@type real
bj_CORPSE_MAX_DEATH_TIME = nil

---0
---@type integer
bj_CORPSETYPE_FLESH = nil

---1
---@type integer
bj_CORPSETYPE_BONE = nil

---'DTep'
---@type integer
bj_ELEVATOR_BLOCKER_CODE = nil

---'DTrf'
---@type integer
bj_ELEVATOR_CODE01 = nil

---'DTrx'
---@type integer
bj_ELEVATOR_CODE02 = nil

---0
---@type integer
bj_ELEVATOR_WALL_TYPE_ALL = nil

---1
---@type integer
bj_ELEVATOR_WALL_TYPE_EAST = nil

---2
---@type integer
bj_ELEVATOR_WALL_TYPE_NORTH = nil

---3
---@type integer
bj_ELEVATOR_WALL_TYPE_SOUTH = nil

---4
---@type integer
bj_ELEVATOR_WALL_TYPE_WEST = nil
